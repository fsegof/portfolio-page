 ...
 */
function deactivate_yllo_plugin() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-plugin-deactivator.php';
	\EWStarter\Plugin_Deactivator::deactivate();
}

register_activation_hook( __FILE__, 'activate_yllo_plugin' );
register_deactivation_hook( __FILE__, 'deactivate_yllo_plugin' );
